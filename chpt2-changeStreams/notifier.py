...
def get_change_stream():
    ...
    """
    pipeline = [
        { '$match': {'operationType': 'update', 'updateDescription.updatedFields.reported' : { '$exists': True } } },
        { '$project': { 'subject': '$fullDocument.subject', 'reported': '$updateDescription.updatedFields.reported' } }
    ]
    return pipeline
